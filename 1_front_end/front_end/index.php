            ...
            <div class="d-md-flex flex-md-equal w-100">
               <div class="bg-game pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden showcase-text" >
                  <div class="my-3 py-3">
                     ...
                     <a class="btn btn-game btn-outline-secondary text-dark" href="gamingGuide.php">Learn More</a>
               ...
               <div class="bg-crypto pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                  <div class="my-3 p-3">
                     ...
                     <a class="btn btn-crypto btn-outline-secondary text-dark" href="cryptoGuide.php">Learn More</a>
