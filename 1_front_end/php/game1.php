...
<main>   
  ...
  <div class="row featurette">
    <div class="col-md-7 order-md-2">
      ...
      <br>
      <p class="lead">Minecraft is a sandbox video game developed by the Swedish video game developer Mojang Studios. The game was created by Markus "Notch" Persson in the Java programming language. 
        ...
        the best-selling video game of all time, with over 238 million copies sold and nearly 140 million monthly active users as of 2021.In Minecraft, players explore a blocky, procedurally generated 3D world with virtually infinite terrain, and may discover and extract raw materials, craft tools and items, 
        and build structures or earthworks</p>
        <br>
        <h3>Star Rating</h3>
    ...
    <div class="col-md-5 order-md-1">
      <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="600" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 700x600" preserveAspectRatio="xMidYMid slice" focusable="false">
        <image  href="../images/image3.png" class = "center" ></image>
      </svg>
    </div>
